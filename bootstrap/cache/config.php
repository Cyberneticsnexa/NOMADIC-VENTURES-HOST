<?php return array (
  ...
  array (
    ...
    'custom-css' => '/assets/back-end/custom/css/custom.css?v=1',
    ...
    'form-validation-init-js' => '/assets/back-end/custom/js/form-validation-init.js?v=1',
    ...
    'user-roll-init-js' => '/assets/back-end/custom/js/user-roll-init.js?v=1',
    'edit-user-roll-init-js' => '/assets/back-end/custom/js/edit-user-roll-init.js?v=1',
    'user-init-js' => '/assets/back-end/custom/js/user-init.js?v=1',
    'vehical-type-init-js' => '/assets/back-end/custom/js/vehical-type-init.js?v=1',
    'vehical-init-js' => '/assets/back-end/custom/js/vehical-init.js?v=1',
    'cropper-min-init-js' => 'https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.0.0-rc.1/cropper.min.js',
    'create-driver-init-js' => '/assets/back-end/custom/js/create-driver-init.js?v=1',
    'room-type-init-js' => '/assets/back-end/custom/js/room-type-init.js?v=1',
    'basis-init-js' => '/assets/back-end/custom/js/basis-init.js?v=1',
    'room-category-init-js' => '/assets/back-end/custom/js/room-category-init.js?v=1',
    'create-hotel-init-js' => '/assets/back-end/custom/js/create-hotel-init.js?v=1',
    'update-hotel-init-js' => '/assets/back-end/custom/js/update-hotel-init.js?v=1',
    'hotel-cities-init-js' => '/assets/back-end/custom/js/hotel-cities-init.js?v=1',
    'hotels-init-js' => '/assets/back-end/custom/js/hotels-init.js?v=1',
    'country-init-js' => '/assets/back-end/custom/js/country-init.js?v=1',
    'nationality-init-js' => '/assets/back-end/custom/js/nationality-init.js?v=1',
    'guide-init-js' => '/assets/back-end/custom/js/guide-init.js?v=1',
    'guide-register-init-js' => '/assets/back-end/custom/js/guide-register-init.js?v=1',
    'agent-init-js' => '/assets/back-end/custom/js/agent-init.js?v=1',
    'tour-list-init-js' => '/assets/back-end/custom/js/tour-list-init.js?v=1',
    'tour-schedule-init-js' => '/assets/back-end/custom/js/tour-schedule-init.js?v=1',
    'tour-schedule-for-hotel-init-js' => '/assets/back-end/custom/js/tour-schedule-for-hotel-init.js?v=1',
    'assign-franchise-init-js' => '/assets/back-end/custom/js/assign-franchise-init.js?v=1',
    'assign-franchise-from-transport-init-js' => '/assets/back-end/custom/js/assign-franchise-from-transport-init.js?v=1',
    'transport-tour-list-init-js' => '/assets/back-end/custom/js/transport-tour-list-init.js?v=1',
    'hotel-tour-list-init-js' => '/assets/back-end/custom/js/hotel-tour-list-init.js?v=1',
    'site-settings-init-js' => '/assets/back-end/custom/js/site-settings-init.js?v=1',
    'edit-driver-init-js' => '/assets/back-end/custom/js/edit-driver-init.js?v=1',
    'dashboard-init-js' => '/assets/back-end/custom/js/dashboard-init.js?v=1',
    'edit-tour-init-js' => '/assets/back-end/custom/js/edit-tour-init.js?v=1',
    'live-path' => '',
  ),
  'view' => 
  array (
