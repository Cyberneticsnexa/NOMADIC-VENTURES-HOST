        ...
        <table id="tour-schedule-table" class="table table-striped table-bordered nowrap" style="width:100%">
            <thead>
                <tr>
                    ...
                    @if (isPermissions('assign-franchises'))
                        <th>Action</th>
                    @endif
                </tr>
            </thead>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                ...
                                {{ $item->HotelDetails->HotelCityDetails->CityName->city }}
                            @endif
                        </td>
                        <td>
                        ...
                        @if (isPermissions('assign-franchises'))
                            <td>
                                @if ($item->guide != null && $item->vehical != null && $item->driver != null)
                                    <a target="_blank" href="/assign-franchises/{{ $item->id }}"
                                        class="btn btn-primary btn-xs">Assign Franchises</i></a>
                                @else
                                    <span class="badge badge-success">Already Assign</span>
                                @endif
                            </td>
                        @endif
                    </tr>
