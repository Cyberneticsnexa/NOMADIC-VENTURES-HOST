...
<div style="text-align:center;">
    <table style="width:100%">
        ...
        <tr>
            <td class="td-details" colspan="1">Booking Date :</td>
        ...
        <tr>
            <td class="td-details">Voucher Number :</td>
            <td class="td-details" colspan="3"><b>{{ $voucher_data['voucher_no'] }}</b>
            </td>
        </tr>
        <tr>
            <td class="td-details">Hotel :</td>
            <td class="td-details" colspan="3">
        ...
        <tr>
            ...
            <td class="td-details">No. of Nights :</td>
        ...
        <tr>
            ...
            <td class="td-details">No. of Guests :</td>
            <td class="td-details">
    ...
    <table style="width:100%;margin-top:20px">
        ...
        @foreach ($voucher_data['get_hotel_rooms'] as $item)
            <tr class="room-info">
                <td class="td-details"><b>{{ $item->RoomTypeDetails->room_type }}</b></td>
                <td class="td-details">
                    @php
