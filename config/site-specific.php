...
return [
    ...
    */
    ...
    'custom-css'                        =>'/assets/back-end/custom/css/custom.css?v='.$version,
    ...
    */
    ...
    'form-validation-init-js'           =>'/assets/back-end/custom/js/form-validation-init.js?v='.$version,
    ...
    */
    ...
    'user-roll-init-js'                 =>'/assets/back-end/custom/js/user-roll-init.js?v='.$version,

    'edit-user-roll-init-js'            =>'/assets/back-end/custom/js/edit-user-roll-init.js?v='.$version,

    'user-init-js'                      =>'/assets/back-end/custom/js/user-init.js?v='.$version,

    'vehical-type-init-js'              =>'/assets/back-end/custom/js/vehical-type-init.js?v='.$version,

    'vehical-init-js'                   =>'/assets/back-end/custom/js/vehical-init.js?v='.$version,

    'cropper-min-init-js'               =>'https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.0.0-rc.1/cropper.min.js',

    'create-driver-init-js'             =>'/assets/back-end/custom/js/create-driver-init.js?v='.$version,

    'room-type-init-js'                 =>'/assets/back-end/custom/js/room-type-init.js?v='.$version,

    'basis-init-js'                     =>'/assets/back-end/custom/js/basis-init.js?v='.$version,

    'room-category-init-js'             =>'/assets/back-end/custom/js/room-category-init.js?v='.$version,

    'create-hotel-init-js'              =>'/assets/back-end/custom/js/create-hotel-init.js?v='.$version,

    'update-hotel-init-js'              =>'/assets/back-end/custom/js/update-hotel-init.js?v='.$version,

    'hotel-cities-init-js'              =>'/assets/back-end/custom/js/hotel-cities-init.js?v='.$version,

    'hotels-init-js'                    =>'/assets/back-end/custom/js/hotels-init.js?v='.$version,

    'country-init-js'                   =>'/assets/back-end/custom/js/country-init.js?v='.$version,

    'nationality-init-js'               =>'/assets/back-end/custom/js/nationality-init.js?v='.$version,

    'guide-init-js'                     =>'/assets/back-end/custom/js/guide-init.js?v='.$version,

    'guide-register-init-js'            =>'/assets/back-end/custom/js/guide-register-init.js?v='.$version,

    'agent-init-js'                     =>'/assets/back-end/custom/js/agent-init.js?v='.$version,

    'tour-list-init-js'                 =>'/assets/back-end/custom/js/tour-list-init.js?v='.$version,

    'tour-schedule-init-js'             =>'/assets/back-end/custom/js/tour-schedule-init.js?v='.$version,

    'tour-schedule-for-hotel-init-js'   =>'/assets/back-end/custom/js/tour-schedule-for-hotel-init.js?v='.$version,

    'assign-franchise-init-js'          =>'/assets/back-end/custom/js/assign-franchise-init.js?v='.$version,

    'assign-franchise-from-transport-init-js'          =>'/assets/back-end/custom/js/assign-franchise-from-transport-init.js?v='.$version,

    'transport-tour-list-init-js'       =>'/assets/back-end/custom/js/transport-tour-list-init.js?v='.$version,

    'hotel-tour-list-init-js'           =>'/assets/back-end/custom/js/hotel-tour-list-init.js?v='.$version,

    'site-settings-init-js'           =>'/assets/back-end/custom/js/site-settings-init.js?v='.$version,

    'edit-driver-init-js'           =>'/assets/back-end/custom/js/edit-driver-init.js?v='.$version,

    'dashboard-init-js'           =>'/assets/back-end/custom/js/dashboard-init.js?v='.$version,
